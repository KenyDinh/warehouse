 ...
 * @author KenyDinh
 */
public class VatLieuNhapFrame extends ElementGui {

    private VatLieuNhap vatlieunhap;
     ...
     */
    public VatLieuNhapFrame() {
        initComponents();
        initLocation();
        initConfig();
        ImageIcon icon = CommonMethod.getImageIcon("vatlieunhap_1");
        if (icon != null) {
    ...
    public void initData(EntityComponent entity) {
        if (entity != null && entity instanceof VatLieuNhap) {
            VatLieuNhap vln = (VatLieuNhap) entity;
            isUpdate = true;
            lb_title.setText("Cập Nhật Thông Tin Vật Liệu");
            btn_ok.setText("Cập Nhật");
            date_ngaynhap.setDate(CommonMethod.getDateStringDB(vln.getNgaynhap()));
            tf_khoiluong.setValue(vln.getKhoiluong());
            CongTrinh c = new CongTrinh();
            c.setMacongtrinh(vln.getMacongtrinh());
            ...
            h.setMahanghoa(vln.getMahanghoa());
            ...
            tf_tonggiatri.setValue(vln.getKhoiluong() * hh.getGia());
            DonVi d = new DonVi();
            d.setMadonvi(hh.getMadonvi());
            EntityComponent e3 = ServiceDAOFactory.select(d);
            if (e3 == null) {
                lb_mess.setText("Không tìm thấy Đơn Vị Vật Liệu!");
                return;
            }
            DonVi dv = (DonVi) e3;
            tf_tendonvi.setText(dv.getMadonvi());
            this.vatlieunhap = vln;
    ...
    private void initComponents() {
        ...
        date_ngaynhap = new org.jdesktop.swingx.JXDatePicker();
        ...
        setTitle("Quản Lý Nhập Vật Liệu");
        ...
        lb_title.setText("Nhập Vật Liệu Mới");
        ...
        date_ngaynhap.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(date_ngaynhap, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void okButton() {
        lb_mess.setText("");
        if (!isUpdate || vatlieunhap == null) {
            vatlieunhap = new VatLieuNhap();
        }
        Date ngaynhap = date_ngaynhap.getDate();
        ...
        if (ngaynhap == null) {
            lb_mess.setText("Ngày nhập không được bỏ trống!");
            return;
        }
        ...
        //
        if (isUpdate) {
            if (vatlieunhap.getMahanghoa().equals(mahanghoa) && vatlieunhap.getKhoiluong() == khoiluong && vatlieunhap.getNgaynhap().equals(CommonMethod.getFormatDateStringDB(ngaynhap))) {
                okCloseFrame();
                return;
            }
        }
        ...
        if (isUpdate) {
            ...
            history.setDateold(vatlieunhap.getNgaynhap());
            history.setKhoiluongcu(vatlieunhap.getKhoiluong());
            history.setMahanghoacu(vatlieunhap.getMahanghoa());
        } else {
        ...
        int klt = 0;
        if (isUpdate) {
            vltk.setMacongtrinh(vatlieunhap.getMacongtrinh());
            vltk.setMahanghoa(vatlieunhap.getMahanghoa());
            EntityComponent e0 = ServiceDAOFactory.select(vltk);
            if (e0 != null) {
                klt = ((VatLieuTonKho) e0).getKhoiluongton();
                vltk.setKhoiluongton(klt - vatlieunhap.getKhoiluong());
                if (!ServiceDAOFactory.insertOrUpdate(vltk)) {
                    CommonMethod.writeLog(Home.tennguoidung, "[ServiceDAOFactory.insertOrUpdate] Fail!");
                }
            }
            
            DuToan dt_old = new DuToan();
            dt_old.setMacongtrinh(vatlieunhap.getMacongtrinh());
            dt_old.setMahanghoa(vatlieunhap.getMahanghoa());
            EntityComponent ed = ServiceDAOFactory.select(dt_old);
            if(ed != null){
                DuToan _dt = (DuToan) ed;
                dt_old.setTongkhoiluong(_dt.getTongkhoiluong() - vatlieunhap.getKhoiluong());
                if(dt_old.getTongkhoiluong() <= 0){
                    ServiceDAOFactory.delete(dt_old);
                }else{
                    if(!ServiceDAOFactory.insertOrUpdate(dt_old)){
                        CommonMethod.writeLog(Home.tennguoidung, "[ServiceDAOFactory.insertOrUpdate] Fail!");
                    }
                }
            }
        ...
        //
        vatlieunhap.setNgaynhap(CommonMethod.getFormatDateStringDB(ngaynhap));
        vatlieunhap.setMacongtrinh(macongtrinh.trim());
        vatlieunhap.setKhoiluong(khoiluong);
        vatlieunhap.setManguoinhap(Home.tennguoidung);
        vatlieunhap.setMahanghoa(mahanghoa);
        //
        vltk = new VatLieuTonKho();
        vltk.setMacongtrinh(vatlieunhap.getMacongtrinh());
        vltk.setMahanghoa(vatlieunhap.getMahanghoa());
        EntityComponent e1 = ServiceDAOFactory.select(vltk);
        klt = 0;
        if (e1 != null) {
            klt = ((VatLieuTonKho) e1).getKhoiluongton();
        }
        vltk.setKhoiluongton(klt + vatlieunhap.getKhoiluong());
        if (!ServiceDAOFactory.insertOrUpdate(vltk)) {
            CommonMethod.writeLog(Home.tennguoidung, "[ServiceDAOFactory.insertOrUpdate] Fail!");
        ...
        //
        history.setDatenew(vatlieunhap.getNgaynhap());
        history.setKhoiluongmoi(vatlieunhap.getKhoiluong());
        history.setMahanghoamoi(vatlieunhap.getMahanghoa());
        history.setMacongtrinh(vatlieunhap.getMacongtrinh());
        history.setType(HistoryType.IN.getName());
        history.setTennguoidung(Home.tennguoidung);
        //
        if (!ServiceDAOFactory.insertOrUpdate(vatlieunhap)) {
            if (isUpdate) {
        ...
        //
        DuToan dt_new = new DuToan();
        dt_new.setMacongtrinh(vatlieunhap.getMacongtrinh());
        dt_new.setMahanghoa(vatlieunhap.getMahanghoa());
        EntityComponent e = ServiceDAOFactory.select(dt_new);
        int curKL = 0;
        if (e != null) {
            DuToan dutoan = (DuToan) e;
            curKL = dutoan.getTongkhoiluong();
        }
        dt_new.setTongkhoiluong(curKL + vatlieunhap.getKhoiluong());
        if (!ServiceDAOFactory.insertOrUpdate(dt_new)) {
            CommonMethod.writeLog(Home.tennguoidung, "[ServiceDAOFactory.insertOrUpdate] Fail!");
        }
        ...
        //
        VatLieuNhap nvln = new VatLieuNhap();
        nvln.setMacongtrinh(vatlieunhap.getMacongtrinh());
        okCloseFrame(nvln);
    }
    ...
    private org.jdesktop.swingx.JXDatePicker date_ngaynhap;
